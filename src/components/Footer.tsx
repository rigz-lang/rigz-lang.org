...
export default function Footer() {
  return (
    <footer className="mt-16 border-t bg-gray-50 text-gray-700 px-6 py-10 text-sm">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-6">
        <div>
          <p className="text-xl font-semibold text-gray-800 mb-2">rigz</p>
        ...
        <div>
          <p className="font-medium text-gray-800 mb-2 text-center block">Connect</p>
          <ul className="flex gap-4 items-center">
            ...
            <li>
              <a
                ...
                aria-label="GitHub"
              >
                <svg role="img" height={logoSize} width={logoSize} fill="#181717" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <title>GitHub</title>
