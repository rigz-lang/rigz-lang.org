...
time. This highlighting is now being used for blogs and the REPL, once I fully iron it out I'll either make a PR to 
highlight.js or create a dedicated npm package that can be used. If you need highlighting you can use [@rigz-lang/highlight.js](https://www.npmjs.com/package/@rigz-lang/highlight.js).
